...
const Banner = () => {
  return (
    <div className="flex flex-col items-center text-center px-6 py-12 bg-white">
      ...
      <div className="w-full text-center">
       ...
       <div class="mb-[100px] bg-[linear-gradient(90deg,#9F62F2_0%,#632EE3_100%)] text-white py-16">
  <div class="max-w-6xl mx-auto text-center px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
      ...
      <div>
        <h3 class="text-lg font-medium text-gray-200 mb-2">Total Downloads</h3>
        <p class="text-4xl font-extrabold">29.6M</p>
        <p class="text-sm text-gray-300 mt-1">27% More Than Last Month</p>
      </div>

     
      <div>
        <h3 class="text-lg font-medium text-gray-200 mb-2">Total Reviews</h3>
        <p class="text-4xl font-extrabold">906K</p>
        <p class="text-sm text-gray-300 mt-1">46% More Than Last Month</p>
      </div>

    
      <div>
        <h3 class="text-lg font-medium text-gray-200 mb-2">Active Apps</h3>
        <p class="text-4xl font-extrabold">132+</p>
        <p class="text-sm text-gray-300 mt-1">31 More Will Launch</p>
      </div>
    </div>
  </div>
</div>
